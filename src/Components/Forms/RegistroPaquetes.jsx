                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-7">
                                <div className="card shadow-lg border-0 rounded-lg mt-5">
                                    <div className="card-header"><h3 className="text-center font-weight-light my-4">Registro de Paquete</h3></div>
                                            ...
                                            <div className="row mb-3">
                                                <div className="col-md-6">
                                                    <div className="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <label for="inputFirstName">Nombre Remitente</label>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-floating">
                                                        <input className="form-control" id="inputLastName" type="text" placeholder="Enter your last name" />
                                                        <label for="inputLastName">Nombre Destinatario</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-md-6">
                                                    <div className="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <label for="inputPasswordConfirm">Codigo postal</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="mt-4 mb-0">
                                                <div className="d-grid"><a className="btn btn-primary btn-block" href="login.html">Registrar Paquete</a></div>
                                            </div>
                                        </form>
                                    </div>
                ...
                <footer className="py-4 bg-light mt-auto">
                    <div className="container-fluid px-4">
                        <div className="d-flex align-items-center justify-content-between small">
                            <div className="text-muted">Equipo1 Ciclo4</div>
                            <div>
                                <a href="#">Uninorte Mintic</a>
                                &middot;
